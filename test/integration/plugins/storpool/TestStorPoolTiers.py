...
class TestStorPoolTiers(cloudstackTestCase):
    ...
    def setUpCloudStack(cls):
        ...
        # cls.volume_tier1_tag = Volume.create(
        #     cls.apiclient,
        #     account=cls.account.name,
        #     domainid=cls.account.domainid,
        #     diskofferingid=cls.disk_offerings_tier1_tags.id,
        #     zoneid=cls.zone.id,
        #     services=cls.services,
        #     size=2
        # )
        # cls.volume_tier2_tag = Volume.create(
        #     cls.apiclient,
        #     account=cls.account.name,
        #     domainid=cls.account.domainid,
        #     diskofferingid=cls.disk_offerings_tier2_tags.id,
        #     services=cls.services,
        #     size=2
        # )
        # cls.volume_tier1_template = Volume.create(
        #     cls.apiclient,
        #     account=cls.account.name,
        #     domainid=cls.account.domainid,
        #     diskofferingid=cls.disk_offerings_tier2_template.id,
        #     services=cls.services,
        #     size=2
        # )
        # cls.volume_tier2_template = Volume.create(
        #     cls.apiclient,
        #     account=cls.account.name,
        #     domainid=cls.account.domainid,
        #     diskofferingid=cls.disk_offerings_tier2_template.id,
        ...
        #     size=2
        # )
        # cls.virtual_machine_tier2_tag = VirtualMachine.create(
        #     cls.apiclient,
        ...
        #     overridediskofferingid=cls.disk_offerings_tier2_tags.id,
        #     hypervisor=cls.hypervisor,
        #     rootdisksize=10
        # )
        # cls.virtual_machine_tier1_template = VirtualMachine.create(
        #     cls.apiclient,
        #     {"name": "StorPool-%s" % uuid.uuid4()},
        #     zoneid=cls.zone.id,
        #     templateid=template.id,
        ...
        #     domainid=cls.account.domainid,
        #     serviceofferingid=cls.service_offering.id,
        #     overridediskofferingid=cls.disk_offerings_tier1_template.id,
        #     hypervisor=cls.hypervisor,
        #     rootdisksize=10
        # )
        # cls.virtual_machine_tier2_template = VirtualMachine.create(
        #     cls.apiclient,
        #     {"name": "StorPool-%s" % uuid.uuid4()},
        #     zoneid=cls.zone.id,
        #     templateid=template.id,
        ...
        #     domainid=cls.account.domainid,
        #     serviceofferingid=cls.service_offering.id,
        #     overridediskofferingid=cls.disk_offerings_tier2_template.id,
        #     hypervisor=cls.hypervisor,
        #     rootdisksize=10
        # )
